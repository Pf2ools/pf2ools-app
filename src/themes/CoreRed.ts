...
export const CoreRed: ThemeConfig = {
	...
	properties: {
		...
		// =~= Theme Colors  =~=
		// primary | #5e0000
		'--color-primary-50': '231 217 217', // #e7d9d9
		'--color-primary-100': '223 204 204', // #dfcccc
		'--color-primary-200': '215 191 191', // #d7bfbf
		'--color-primary-300': '191 153 153', // #bf9999
		'--color-primary-400': '142 77 77', // #8e4d4d
		'--color-primary-500': '94 0 0', // #5e0000
		'--color-primary-600': '85 0 0', // #550000
		'--color-primary-700': '71 0 0', // #470000
		'--color-primary-800': '56 0 0', // #380000
		'--color-primary-900': '46 0 0', // #2e0000
		// secondary | #c2a200
